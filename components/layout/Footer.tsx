        ...
        <div className="grid grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link href="/dashboard/company" className="text-xs text-gray-500 hover:text-sage transition-colors">공고 등록</Link>
              <Link href="/payment" className="text-xs text-gray-500 hover:text-sage transition-colors">에스크로 결제</Link>
